...
def create_workflow():
    ...
    # Add all nodes
    workflow.add_node("title_scraper", title_scraper_node)  # ✅ ADD THIS
    ...
    # Sequential flow
    workflow.add_edge(START, "title_scraper")  # ✅ START HERE
    workflow.add_edge("title_scraper", "query_researcher")  # ✅ THEN THIS
